...
// Produit sélectionné pour la card (si id dans l’URL)
$selected_id = filter_var(GETPOST('id'), FILTER_VALIDATE_INT);
$selected = $selected_id ? Produits::findById($db, $selected_id) : null;